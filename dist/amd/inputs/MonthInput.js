...
define(["require", "exports", "lodash/invoke", "moment", "react", "../pickers/monthPicker/MonthPicker", "../views/InputView", "./BaseInput", "./parse"], function (require, exports, invoke_1, moment_1, React, MonthPicker_1, InputView_1, BaseInput_1, parse_1) {
    "use strict";
    ...
    var MonthInput = /** @class */ (function (_super) {
        ...
        function MonthInput(props) {
            ...
            _this.handleSelect = function (e, _a) {
                ...
                invoke_1.default(_this.props, 'onChange', e, __assign(__assign({}, _this.props), { value: output }));
