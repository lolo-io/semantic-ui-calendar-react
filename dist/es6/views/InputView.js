    ...
    function InputView() {
        ...
        _this.onBlur = function (e) {
            ...
            if (e.relatedTarget !== _this.popupNode
                ...
                && !checkIE()) {
                invoke.apply(void 0, __spreadArrays([_this.props, 'onBlur', e], args));
                closePopup();
            }
        };
        _this.onMouseLeave = function (e) {
            ...
            if (e.relatedTarget !== _this.popupNode && e.relatedTarget !== _this.inputNode) {
                if (closeOnMouseLeave) {
                    invoke.apply(void 0, __spreadArrays([_this.props, 'onMouseLeave', e], args));
        ...
        _this.onMouseEnter = function (e) {
            ...
            invoke.apply(void 0, __spreadArrays([_this.props, 'onMouseEnter', e], args));
