...
var MinuteView = /** @class */ (function (_super) {
    ...
    MinuteView.prototype.render = function () {
        ...
        return (React.createElement(Calendar, __assign({ ref: function (e) { return _this.calendarNode = findHTMLElement(e); }, outlineOnFocus: inline }, rest),
            ...
            React.createElement(Body, { width: rowWidth, data: values, hovered: hoveredItemIndex, onCellHover: onCellHover, onCellClick: onValueClick, active: activeItemIndex, disabled: disabledItemIndexes })));
    };
    return MinuteView;
}(BaseCalendarView));
